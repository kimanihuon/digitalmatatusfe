    ...
    <div v-if="!auth">
      ...
      <v-dialog v-model="dialog" max-width="290">
        <v-card>
          <v-card-text
            class="pt-4"
          >Ooops! Something happened. Please try again. {{ requestResponse }}</v-card-text>
      ...
      <v-card class="mx-auto" width="420" height="620" elevation="5">
        <!-- Banner -->
        ...
        <v-col align="center">
          <div>
            <v-btn medium color="#db3236" rounded dark>
              <v-icon left medium>mdi-google</v-icon>Google
            </v-btn>
          </div>
          <v-divider class="my-3"></v-divider>
          <div>
            <v-btn medium color="#00acee" rounded dark>
              <v-icon left medium>mdi-twitter</v-icon>Twitter
            </v-btn>
          </div>
        </v-col>
      </v-card>
    ...
    <div v-if="auth">
      <v-row no-gutters>
        <v-col justify="center" align="center">
          <v-img src="@/assets/button.svg" alt="Logged in" class="img" max-height="550">
          </v-img>
